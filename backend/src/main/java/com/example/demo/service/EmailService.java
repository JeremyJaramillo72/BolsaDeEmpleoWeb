...
public class EmailService {
    ...
    private String generarTemplateCodigoVerificacion(String codigo) {
        return "<html lang=\"es\"><head><meta charset=\"UTF-8\"><meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\"><style>" +
                ...
                ".header { background: linear-gradient(135deg, #0ea5e9 0%, #1e40af 100%); padding: 40px 30px; text-align: center; color: white; }" + // Cambiado a Azul
                ".header h1 { margin: 0; font-size: 24px; font-weight: 700; }" +
                ".content { padding: 40px 30px; text-align: center; }" +
                ".codigo-box { background-color: #f0f9ff; border: 2px solid #0ea5e9; border-radius: 8px; padding: 30px; margin: 30px 0; }" +
                ".codigo { font-size: 48px; font-weight: 700; color: #0284c7; letter-spacing: 8px; text-align: center; font-family: 'Courier New', monospace; }" +
                ".descripcion { color: #334155; font-size: 16px; line-height: 1.6; }" + // Texto más grande y oscuro
    ...
    private String generarTemplateValidacion(String nombreEmpresa, String estado) {
        ...
        return "<html lang=\"es\"><head><meta charset=\"UTF-8\"><meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\"><style>" +
                ...
                ".content { padding: 40px 30px; }" +
                ".greeting { color: #1e293b; font-size: 18px; margin-bottom: 20px; }" + // Aumentado a 18px
                ...
                ".estado-label { color: #64748b; font-size: 13px; font-weight: 600; text-transform: uppercase; margin-bottom: 5px; }" +
                ".estado-valor { color: " + colorEstado + "; font-size: 20px; font-weight: 700; }" + // Aumentado a 20px
                ".exito { color: #15803d; line-height: 1.6; font-size: 16px; }" + // Aumentado a 16px
                ".error { color: #b91c1c; line-height: 1.6; font-size: 16px; }" + // Aumentado a 16px
                ".descripcion { color: #334155; font-size: 16px; line-height: 1.6; margin: 15px 0; }" + // Aumentado a 16px y oscurecido
                ".footer { background-color: #f8fafc; padding: 25px 30px; text-align: center; border-top: 1px solid #e2e8f0; }" +
                ".footer p { color: #94a3b8; font-size: 12px; margin: 5px 0; }" +
                "</style></head><body>" +
                "<div class=\"container\">" +
    ...
    private String generarTemplateCuentaNoAprobada(String nombreEmpresa, String estadoActual) {
        ...
        return "<html lang=\"es\"><head><meta charset=\"UTF-8\"><meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\"><style>" +
                ...
                ".alerta-titulo { color: #b45309; font-size: 15px; font-weight: 600; text-transform: uppercase; margin-bottom: 8px; }" +
                ".alerta-contenido { color: #92400e; font-size: 16px; line-height: 1.6; }" + // Aumentado a 16px
                ".estado-actual { color: #d97706; font-weight: 700; }" +
                ".descripcion { color: #334155; font-size: 16px; line-height: 1.6; margin: 15px 0; }" + // Aumentado a 16px
                ".footer { background-color: #f8fafc; padding: 25px 30px; text-align: center; border-top: 1px solid #e2e8f0; }" +
                ".footer p { color: #94a3b8; font-size: 12px; margin: 5px 0; }" +
                "</style></head><body>" +
                "<div class=\"container\">" +
    ...
    private String generarTemplateGenerico(String contenido) {
        return "<html lang=\"es\"><head><meta charset=\"UTF-8\"><meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\"><style>" +
                "body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background-color: #f5f7fa; margin: 0; padding: 0; }" +
                ".container { max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 16px rgba(0,0,0,0.12); }" +
                ".header { background: linear-gradient(135deg, #0284c7 0%, #059669 100%); padding: 40px 30px; text-align: center; color: white; }" + // Cambiado a degradado Azul-Verde
                ".header h1 { margin: 0; font-size: 24px; font-weight: 700; }" +
                ".content { padding: 40px 30px; }" +
                // 🔥 AQUI ESTÁ EL PRE-WRAP PARA QUE EL CORREO RESPETE LOS ENTERS DE TU BD
                ".content p { color: #334155; font-size: 16px; line-height: 1.6; margin: 15px 0; white-space: pre-wrap; }" +
                ".footer { background-color: #f8fafc; padding: 25px 30px; text-align: center; border-top: 1px solid #e2e8f0; }" +
                ".footer p { color: #94a3b8; font-size: 12px; margin: 5px 0; }" +
                "</style></head><body>" +
                "<div class=\"container\">" +
    ...
    private String generarTemplateAlertaSeguridad(String tiempo, String ip, String ubicacion) {
        return "<html lang=\"es\"><head><meta charset=\"UTF-8\"><meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\"><style>" +
                ...
                ".alerta-texto p { color: #7f1d1d; margin: 8px 0; font-size: 16px; line-height: 1.6; }" + // Aumentado a 16px
                ...
                ".detalle-etiqueta { color: #64748b; font-weight: 600; width: 120px; font-size: 14px; text-transform: uppercase; }" + // Aumentado a 14px
                ".detalle-valor { color: #1e293b; font-family: 'Courier New', monospace; font-size: 14px; word-break: break-all; }" + // Aumentado a 14px
                ".accion { background-color: #fecaca; color: #7f1d1d; padding: 15px 20px; border-radius: 8px; margin: 20px 0; text-align: center; font-size: 16px; line-height: 1.6; font-weight: 500; }" + // Aumentado a 16px
                ".descripcion { color: #334155; font-size: 16px; line-height: 1.6; margin: 15px 0; }" + // Aumentado a 16px
                ".footer { background-color: #f8fafc; padding: 25px 30px; text-align: center; border-top: 1px solid #e2e8f0; }" +
                ".footer p { color: #94a3b8; font-size: 12px; margin: 5px 0; }" +
                "h3 { color: #1e293b; margin-top: 30px; margin-bottom: 15px; font-size: 18px; }" + // Aumentado a 18px
                "</style></head><body>" +
                "<div class=\"container\">" +
                "<div class=\"header\"><div class=\"icono\">🔒</div>" +
    ...
    private String generarTemplateAprobacionEmpresa(String nombreEmpresa) {
        return "<html lang=\"es\"><head><meta charset=\"UTF-8\"><meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\"><style>" +
                ...
                ".success-label { color: #64748b; font-size: 13px; font-weight: 600; text-transform: uppercase; margin-bottom: 5px; }" +
                ".success-mensaje { color: #15803d; font-size: 18px; font-weight: 700; line-height: 1.6; }" + // Aumentado a 18px
                ".descripcion { color: #334155; font-size: 16px; line-height: 1.6; margin: 15px 0; }" + // Aumentado a 16px
                ".boton { display: inline-block; background-color: #16a34a; color: white; padding: 12px 30px; border-radius: 6px; text-decoration: none; font-weight: 600; margin: 20px 0; text-align: center; font-size: 16px; }" +
                ".footer { background-color: #f8fafc; padding: 25px 30px; text-align: center; border-top: 1px solid #e2e8f0; }" +
                ".footer p { color: #94a3b8; font-size: 12px; margin: 5px 0; }" +
                "</style></head><body>" +
                "<div class=\"container\">" +
                ...
                "<ul style=\"color: #334155; font-size: 16px; line-height: 1.8;\">" + // Letra más grande y oscura
