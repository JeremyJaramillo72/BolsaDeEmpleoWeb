...
export class PerfilService {
  ...
  buscarCargosPredictivo(termino: string): Observable<any[]> {
    ...
    return this.http.get<any[]>(`${this.apiCatalogos}/cargos/buscar`, { params });
  }

  buscarEmpresasPredictivo(termino: string): Observable<any[]> {
    const params = new HttpParams().set('termino', termino);
    return this.http.get<any[]>(`${this.apiCatalogos}/buscar`, { params });
  }
